Directive-ID: sprint-l-feature-validation-r3-2026-05-21
...
Validation-Scope: Rerun Sprint L feature validation requiring clean frontend install/lint/build evidence
Allow-Code-Changes: false
Allow-Product-Push: false
Report branch: reports/lubuntu-validation
Report path: docs/ai-reports/lubuntu/2026-05-21_sprint_l_feature_validation_r3.md

# Sprint L Feature Branch Validation R3
...
R3 reason:
R2 proved frontend lint/build can pass, but its report still said `pnpm install` exited 1 because of runner-side build-approval noise. R3 must provide clean App Import Smoke evidence: install command exit 0, lint exit 0, and build exit 0.
