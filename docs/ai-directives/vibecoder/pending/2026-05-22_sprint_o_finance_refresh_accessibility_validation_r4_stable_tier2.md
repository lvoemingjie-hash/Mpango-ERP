Directive-ID: ghost-qa-tier2-sprint-o-finance-refresh-accessibility-r4-stable-tier2-2026-05-22
...
Validation-Scope: Sprint O exact-hash validation after Tier 2 row-visibility wait hardening
Allow-Code-Changes: false
Allow-Product-Push: false
Report branch: reports/lubuntu-validation
Report path: docs/ai-reports/lubuntu/2026-05-22_sprint_o_finance_refresh_accessibility_validation_r4_stable_tier2.md

# Sprint O Finance Refresh Accessibility Validation R4 Stable Tier2

Objective:
Confirm the Sprint O product commit still passes the strict exact-hash validation after the Tier 2 browser journey harness waits for visible receivable rows after route recovery and tab changes.
...
- App Import Smoke must include Sprint O label contract pass, Tier 2 journey pass, and stale page recovery pass.
