...
029_durable_approval_store against an ephemeral PostgreSQL database and proves:
  - the migration is ADDITIVE-ONLY: upgrading from the base revision (019) to head (029)
...
# Pinned upper bound: this test exercises 019 <-> 029 ONLY. It must not follow a
