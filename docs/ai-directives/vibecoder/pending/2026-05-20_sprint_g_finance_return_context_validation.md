Directive-ID: sprint-g-finance-return-context-validation-2026-05-20
Mode: VALIDATION_GATE
Priority: HIGH
Created: 2026-05-20
Status: pending
Target branch: codex/sprint-g-finance-return-context-2026-05-20
Target-Commit: 31ddaa68db7017ff173dde6b347b6e3d2e2e1463
Validation-Scope: Feature-branch validation for Sprint G receivables return context
Allow-Code-Changes: false
Allow-Product-Push: false
Report branch: reports/lubuntu-validation
Report path: docs/ai-reports/lubuntu/2026-05-20_sprint_g_finance_return_context_validation.md

# Sprint G Finance Return Context Validation

Objective:
Validate `origin/codex/sprint-g-finance-return-context-2026-05-20` before any promotion decision. This slice preserves Accounts Receivable tab/page context when a user clicks Collect, records payment in Sales, and returns to Finance.

Required branch/commit checks:
1. `git fetch origin --prune`
2. `git checkout origin/codex/sprint-g-finance-return-context-2026-05-20 --detach`
3. `git rev-parse HEAD`
4. Confirm HEAD equals `31ddaa68db7017ff173dde6b347b6e3d2e2e1463`.
...
- COMMIT_HASH: 31ddaa68db7017ff173dde6b347b6e3d2e2e1463.
