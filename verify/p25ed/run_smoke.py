"""
P25-ED-R1 Real-Stack Smoke Orchestrator.
...
Usage:
  cd c:\\Users\\Jeff0\\MPANGO ERP\\_p25ed_2026-07-08\\backend
  python ../verify/p25ed/run_smoke.py
"""
import json
import os
import signal
...
def run_identity_smoke():
    ...
    return {
        "test_suite": "P25-ED-R1 Identity Smoke",
        "endpoint": FULL_URL,
...
def run_route_smoke():
    ...
    try:
        ...
        return {"test_suite": "P25-ED-R1 Route Smoke", "error": "playwright not installed"}
    ...
    return {
        "test_suite": "P25-ED-R1 Route Smoke",
...
def main():
    print("=" * 70)
    print("P25-ED-R1: Real-Stack Smoke Orchestrator")
    ...
    if identity_ok and route_ok and log_ok:
        print("  OVERALL: P25ED_SYSTEM_DB_CONTEXT_READY")
    else:
