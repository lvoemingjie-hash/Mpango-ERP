Directive-ID: ghost-qa-tier3-finance-receivables-exploratory-r2-2026-05-22
...
Validation-Scope: Tier3 exploratory Ghost QA R2 after Retry button expectation correction
Allow-Code-Changes: false
Allow-Product-Push: false
Report branch: reports/lubuntu-validation
Report path: docs/ai-reports/lubuntu/2026-05-22_tier3_finance_receivables_exploratory_validation_r2.md

# Tier3 Finance Receivables Exploratory Validation R2

Objective:
Rerun the Tier3 exploratory Ghost QA validation against the exact product commit after correcting the script to click the existing `Retry` error-recovery button.
