...
**Accepted readiness-debt merge:** `a6ef3aac...` — DC-12R1-MVP-R0-R1 P2/P3 readiness-debt closure. The H7 dependency manifest reconciliation (`zcode/dc12r1-h7-bcrypt-manifest-reconciliation-2026-08-12`) branches from this tip and is the active pre-deployment prerequisite; H7-R4-R1 (current) supersedes H7-R4, tightening the source-shape guards (multi-line block tracking, continuation joining, inert/dead-branch detection) against two remaining false-green paths; no deployment/Playwright/VPS/native-setup.sh claim.
