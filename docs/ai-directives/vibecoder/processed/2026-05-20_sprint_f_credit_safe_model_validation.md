Directive-ID: sprint-f-credit-safe-model-validation-2026-05-20
Mode: VALIDATION_GATE
Priority: HIGH
Created: 2026-05-20
Status: pending
Target branch: codex/sprint-f-credit-safe-model-2026-05-19
Target-Commit: df6d5751185a0f16fea46d31e1575db226a5d353
Validation-Scope: Feature-branch validation for Sprint F credit-safe collection flow
Allow-Code-Changes: false
Allow-Product-Push: false
Report branch: reports/lubuntu-validation
Report path: docs/ai-reports/lubuntu/2026-05-20_sprint_f_credit_safe_model_validation.md

# Sprint F Credit-Safe Model Validation

Objective:
Validate `origin/codex/sprint-f-credit-safe-model-2026-05-19` before any promotion decision. This slice improves frontend credit-sale safety in the payment modal: Credit Sale auto-fills the full order total, explains receivable implications, and is unavailable for partially-paid orders. It must not alter backend payment/accounting semantics.

Required branch/commit checks:
1. `git fetch origin --prune`
2. `git checkout origin/codex/sprint-f-credit-safe-model-2026-05-19 --detach`
3. `git rev-parse HEAD`
4. Confirm HEAD equals `df6d5751185a0f16fea46d31e1575db226a5d353`.
...
- COMMIT_HASH: df6d5751185a0f16fea46d31e1575db226a5d353.
