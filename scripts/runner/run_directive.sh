...
### Preflight Evidence
- CMD1_FETCH: $EVIDENCE_CMD1_FETCH
- CMD2_CHECKOUT: $EVIDENCE_CMD2_CHECKOUT
- CMD3_REVPARSE: $EVIDENCE_CMD3_REVPARSE
- CMD4_STATUS: $EVIDENCE_CMD4_STATUS
- CMD5_LOG: $EVIDENCE_CMD5_LOG

### Product Validation Evidence
- APP_IMPORT_SMOKE: $EVIDENCE_APP_IMPORT
- RECEIVABLES_SUITE: $EVIDENCE_RECEIVABLES
- PHASE5_PAYMENT_REGRESSION: $EVIDENCE_PHASE5_PAYMENT
- SCHEMA_CONTRACT: $EVIDENCE_SCHEMA_CONTRACT
- SCHEMA_SKIP_REASONS: $EVIDENCE_SCHEMA_SKIP_REASONS
"
