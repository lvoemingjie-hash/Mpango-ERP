Directive-ID: night-sprint-n-ghost-qa-validation-2026-05-22
Mode: VALIDATION_GATE
Priority: HIGH
Created: 2026-05-22
Status: pending
Target branch: codex/product-night-sprint-n-2026-05-22
Target-Commit: 6da437211329354ae45235e28cb9a70b0e1dc3d2
Validation-Scope: Night Sprint N Finance receivables page recovery ghost QA validation
Allow-Code-Changes: false
Allow-Product-Push: false
Report branch: reports/lubuntu-validation
Report path: docs/ai-reports/lubuntu/2026-05-22_night_sprint_n_ghost_qa_validation.md

# Night Sprint N Ghost QA Validation

Objective:
Validate `origin/codex/product-night-sprint-n-2026-05-22` before CTO decides whether to merge it into `product-dev-recovered`.

Validation contract:
Use `docs/ai-directives/vibecoder/contracts/ghost_qa_validation_contract.md` as the human-centered validation standard. This run is not just a test-count check. It must try to disprove the worker's claim that the Finance receivables UX recovers correctly from stale/out-of-range URLs.

Required branch/commit checks:
1. `git fetch origin --prune`
2. `git checkout origin/codex/product-night-sprint-n-2026-05-22 --detach`
3. `git rev-parse HEAD`
4. Confirm HEAD equals `6da437211329354ae45235e28cb9a70b0e1dc3d2`.
...
- Commit Hash: 6da437211329354ae45235e28cb9a70b0e1dc3d2

Ghost QA scenario obligations:
- Confirm the branch explicitly handles a bookmarked/shared Finance URL whose requested page is beyond the available API pagination page count.
