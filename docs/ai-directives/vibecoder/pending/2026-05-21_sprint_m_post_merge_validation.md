Directive-ID: sprint-m-post-merge-validation-2026-05-21
...
Validation-Scope: Post-merge validation for Sprint M after promotion into product-dev-recovered
Allow-Code-Changes: false
Allow-Product-Push: false
Report branch: reports/lubuntu-validation
Report path: docs/ai-reports/lubuntu/2026-05-21_sprint_m_post_merge_validation.md

# Sprint M Post-Merge Validation

Objective:
Validate `origin/product-dev-recovered` after Sprint M was fast-forward merged and pushed.
