Directive-ID: sprint-i-post-merge-validation-2026-05-20
Mode: VALIDATION_GATE
Priority: HIGH
Created: 2026-05-20
Status: pending
Target branch: product-dev-recovered
Target-Commit: 015c56f600abbf1228d11d4c67058d229c65e777
Validation-Scope: Post-merge validation for Sprint I Finance refresh confirmation on product-dev-recovered
Allow-Code-Changes: false
Allow-Product-Push: false
Report branch: reports/lubuntu-validation
Report path: docs/ai-reports/lubuntu/2026-05-20_sprint_i_post_merge_validation.md

# Sprint I Post-Merge Validation

Objective:
Validate `origin/product-dev-recovered` after Sprint I was merged and pushed. The merged baseline must prove the same frontend, receivables, payment, and live schema contract evidence as the validated feature branch.

Required branch/commit checks:
1. `git fetch origin --prune`
2. `git checkout origin/product-dev-recovered --detach`
3. `git rev-parse HEAD`
4. Confirm HEAD equals `015c56f600abbf1228d11d4c67058d229c65e777`.
...
- Commit Hash: 015c56f600abbf1228d11d4c67058d229c65e777
