Directive-ID: sprint-g-post-merge-validation-2026-05-20
Mode: VALIDATION_GATE
Priority: HIGH
Created: 2026-05-20
Status: pending
Target branch: product-dev-recovered
Target-Commit: 537462fdf59b9fe216ea54aa4c05d4490fce53b3
Validation-Scope: Post-merge validation for Sprint G finance return context on product-dev-recovered
Allow-Code-Changes: false
Allow-Product-Push: false
Report branch: reports/lubuntu-validation
Report path: docs/ai-reports/lubuntu/2026-05-20_sprint_g_post_merge_validation.md

# Sprint G Post-Merge Validation

Objective:
Validate `origin/product-dev-recovered` after Sprint G was merged and pushed. The merged baseline must prove the same frontend, receivables, payment, and live schema contract evidence as the validated feature branch.

Required branch/commit checks:
1. `git fetch origin --prune`
2. `git checkout origin/product-dev-recovered --detach`
3. `git rev-parse HEAD`
4. Confirm HEAD equals `537462fdf59b9fe216ea54aa4c05d4490fce53b3`.
...
- COMMIT_HASH: 537462fdf59b9fe216ea54aa4c05d4490fce53b3.
