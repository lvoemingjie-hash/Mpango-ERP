...
Generated at: 2026-07-03T14:30:04+08:00
Repo path: /home/ivy/MPANGO/mpango-promotion-validation
Current branch: reports/lubuntu-validation
Current HEAD: fd7f64b

## Remote Heads

- origin/product-dev-recovered: f3a7261
- origin/platform-dev: 0955495
- origin/reports/lubuntu-validation: e193544

## Active Codex Branches

```
2026-07-03 13:11:56 +0800 origin/codex/platform-p22e3-backup-check-read-only-binding-2026-07-03 dc305ba docs(P22-E3): read-only backup.check source binding ledger
...
- product-dev-recovered (21eca62 -> f3a7261)
- platform-dev (eb5268c -> 0955495)
- codex/* (92837d9 -> dc305ba)
