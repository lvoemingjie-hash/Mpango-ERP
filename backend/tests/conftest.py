...
DC-11T0: TEST_DATABASE_URL is preferred for deterministic database runs.
"""
import os
...
def _resolve_test_database_url() -> str:
    ...
    Priority:
      1. TEST_DATABASE_URL env var (authoritative when set)
...
# DC-11T0: Fail closed when the unresolved container-only default is used.
