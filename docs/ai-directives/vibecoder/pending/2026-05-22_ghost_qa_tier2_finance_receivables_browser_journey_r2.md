Directive-ID: ghost-qa-tier2-finance-receivables-browser-journey-r2-2026-05-22
...
Validation-Scope: Tier 2 Ghost QA browser journey R2 after refresh-feedback locator hardening
Allow-Code-Changes: false
Allow-Product-Push: false
Report branch: reports/lubuntu-validation
Report path: docs/ai-reports/lubuntu/2026-05-22_ghost_qa_tier2_finance_receivables_browser_journey_r2.md

# Ghost QA Tier 2 — Finance Receivables Browser Journey R2

Objective:
Re-run Tier 2 after fixing the harness to treat duplicate `Refreshing...` controls as acceptable visible feedback, rather than a product failure. The product target remains unchanged.
...
- Confirm at least one visible `Refreshing...` feedback control during refresh.
