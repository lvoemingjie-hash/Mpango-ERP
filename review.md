...
cumulative HE2-ET1-R1 → E1 evolution of the harness governance and
...
| detect-secrets | **3 findings (whitelisted)** | Hex SHA-256 hashes in `protocol-deltas.json` lines 94, 111, 125 — governance artifacts, not secrets |
