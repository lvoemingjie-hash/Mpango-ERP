...
Usage:
  cd c:\\Users\\Jeff0\\MPANGO ERP\\_p25ee_2026-07-08\\backend
  python ../verify/p25ee/run_smoke.py
"""
import json
import os
import signal
...
def run_identity_smoke():
    ...
    return {
        "test_suite": "P25-EE Identity Smoke",
        "endpoint": FULL_URL,
...
def run_route_smoke():
    ...
    try:
        ...
        return {"test_suite": "P25-EE Route Smoke", "error": "playwright not installed"}
...
def main():
    print("=" * 70)
    print("P25-EE: Real-Stack Smoke Orchestrator")
