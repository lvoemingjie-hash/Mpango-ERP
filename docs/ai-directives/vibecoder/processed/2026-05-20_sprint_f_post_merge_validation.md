Directive-ID: sprint-f-post-merge-validation-2026-05-20
Mode: VALIDATION_GATE
Priority: HIGH
Created: 2026-05-20
Status: pending
Target branch: product-dev-recovered
Target-Commit: a5db3e10620ee9914c1c04551965736a08a5d399
Validation-Scope: Post-merge validation for Sprint F credit-safe collection flow on product-dev-recovered
Allow-Code-Changes: false
Allow-Product-Push: false
Report branch: reports/lubuntu-validation
Report path: docs/ai-reports/lubuntu/2026-05-20_sprint_f_post_merge_validation.md

# Sprint F Post-Merge Validation

Objective:
Validate `origin/product-dev-recovered` after Sprint F was merged and pushed. The merged baseline must prove the same frontend, receivables, payment, and live schema contract evidence as the validated feature branch.

Required branch/commit checks:
1. `git fetch origin --prune`
2. `git checkout origin/product-dev-recovered --detach`
3. `git rev-parse HEAD`
4. Confirm HEAD equals `a5db3e10620ee9914c1c04551965736a08a5d399`.
...
- COMMIT_HASH: a5db3e10620ee9914c1c04551965736a08a5d399.
