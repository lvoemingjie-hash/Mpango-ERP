...
Permission code format (MVP frozen): `<resource><action>` (no colon). Examples: usersread, ordersconfirm, purchaseordersreceive
...
- warehouse:
  - products:read
  - inventory:read, inventory:adjust, inventorylog:read
